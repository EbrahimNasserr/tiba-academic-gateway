...
export default function Testimonial() {
  return <>
   <section className="py-12  sm:py-16 lg:py-20">
    <h1 className='mb-5 text-center text-3xl font-bold  sm:text-4xl xl:text-5xl font-pj'>Testimonial</h1>
  <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
    <div className="flex flex-col items-center">
      <div className="text-center">
        <h2 className="mt-4 text-3xl font-bold  sm:text-4xl xl:text-5xl font-pj">Our happy Students say about us</h2>
      </div>
