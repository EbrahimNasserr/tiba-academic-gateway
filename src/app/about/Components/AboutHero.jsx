      ...
      <div className="custom-container">
            ...
            <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p className="font-normal text-base leading-6  ">          Tiba Academic Gateway is a student-centered platform dedicated to supporting academic growth and success. We provide organized access to courses, lectures, and essential academic books — all tailored for the four academic years of college. Whether you're just starting or preparing for graduation, Tiba is your trusted educational partner.
                    </p>
                </div>
